...
class ConsultantService:
    ...
    def _ask_gemini(self, lead, user_text: str, catalog_matches, strict_match) -> str:
        ...
        prompt = (
            ...
            "Jesli klient pyta o cene, dla Apple najpierw preferuj ceny z iflix, a dopiero potem z innych polskich serwisow. "
            "Nie zawyzaj cen wzgledem iflix i podobnych ofert rynkowych. "
            ...
            "Odpowiedz ma miec 2 do 4 krotkich zdan. "
